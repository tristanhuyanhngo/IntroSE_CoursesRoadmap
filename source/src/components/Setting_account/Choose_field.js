...
function Choose_field() {
    return (
        <div className="card flex-col p-3 border-0 shadow rounded-3">
            ...
            <ListGroup >
                <ListGroup.Item action id='personal' active onClick={()=>navigate('personal')}>Personal</ListGroup.Item>
                <ListGroup.Item action id='ch_passwd' onClick={()=>navigate('ch_passwd')}>Change password</ListGroup.Item>
                <ListGroup.Item action id='social' onClick={()=>navigate('social')}  >Social</ListGroup.Item>
            </ListGroup>
        </div>
    );
}
