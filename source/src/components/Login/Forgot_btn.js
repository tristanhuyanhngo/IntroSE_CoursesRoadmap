...
class Forgot_btn extends Component {
    ...
    render_button = () =>{
        ...
        if (this.state.btn_status == 'forgot')
            return <button type="button" class="btn btn-success" onClick={this.btnClick}>Send password reset email</button>
        else 
            return <button type="button" class="btn btn-success" data-bs-dismiss="modal"  onClick={this.btnClick}>I get it</button>
    }
